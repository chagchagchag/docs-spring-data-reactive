...
ReactiveMongoTemplate 는 ReactiveMongoDatabaseFactory 객체를 멤버필드로 바인딩하고 있고, MongoDatabase 객체는 ReactiveMongoDatabaseFactory 객체를 통해서 접근 가능하고  MongoCollection 객체는 MongoDatabase 객체를 통해 접근 가능합니다.<B/>
