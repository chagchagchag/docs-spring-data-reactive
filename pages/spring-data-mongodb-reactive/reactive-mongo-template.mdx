...
ReactiveMongoTemplate 은 쿼리를 통해서 내부적으로 데이터를 변환해서 리턴하려면 ReactiveMongoTemplate 내부에서 MongoCollection 에 접근을 하게 됩니다. 이때 ReactiveMongoDatabaseFactory 객체의 getMongoDatabase() 를 통해서 MongoDatabase 를 얻어오고 MongoCollection 에 접근하게 됩니다.<br/>
